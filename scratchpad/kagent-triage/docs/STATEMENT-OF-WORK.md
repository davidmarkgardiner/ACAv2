...
**Pattern B — ASO-driven fast cluster recovery:**
- Because every cluster is defined in Git (KRO instance + Flux bootstrap), a cluster that goes down can be recreated by ASO without manual intervention
...
| **Phase 2 — Automation** | 2–4 | WS2, WS3 | Namespace onboarding live; first fleet ring delivery pipeline |
| **Phase 3 — Resilience & AI** | 3–5 | WS4, WS5b/c | Dev cluster RTO < 30 min chaos-tested; kagent SRE pipeline end-to-end |
| **Phase 4 — Agent Platform & Handover** | 5–6 | WS6, all | Enterprise agent platform live; 3–5 business teams onboarded; runbooks; training |
...
- Migration of existing application workloads (platform tooling only in this engagement)
