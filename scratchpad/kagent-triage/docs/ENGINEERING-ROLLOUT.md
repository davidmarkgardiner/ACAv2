...
> Phase 1: xxx does the first namespace end-to-end. Document everything.
...
**Current state:** Issues go to xxx's personal project (`68265584`). This won't work for team rollout.
...
data:
  ...
  # Get IDs: curl -H "PRIVATE-TOKEN: $TOKEN" "https://gitlab.com/api/v4/users?username=xxx.gardiner"
  roster: |
    [
      {"username": "xxx.gardiner", "gitlab_id": 0},
...
## Phase 1: xxx Does the First Namespace (Day 1)
...
**Recommended: `cert-manager`** — already partially tested (3/5 pass on proxmox-k8s), well-understood failure modes, worker cluster namespace with no EventHub dependency.
...
- [ ] xxx's Phase 1 documented and shared as the reference
...
2. **Documented process** — this doc + Namespace Lifecycle + xxx's Phase 1 reference
