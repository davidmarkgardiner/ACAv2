...
- **Endpoint:** http://<local-llm-host>:<port>
- **Features:**
...
**Project:** https://gitlab.com/<your-org>/<your-project>
...
export LOCAL_LLM_URL="http://<local-llm-host>:<port>/openai/v1"
```
...
- Team - Implementation, testing, documentation
